...
class Siswa{
  ...
  Siswa(int id,String nis, String password, String nama, String jk, String kelas, String jurusan){
    this._id = id;
    this._nis = nis;
  ...
  String getPasswrod()=>this._password;
...
class SiswaService{
  ...
  Future<Siswa> getById(String id)async{
    ...
    Siswa siswa = Siswa(int.parse(data[0]['id_siswa']), 
    data[0]['nis'], 
    data[0]['password'], 
    data[0]['nama'], 
    data[0]['jk'], 
